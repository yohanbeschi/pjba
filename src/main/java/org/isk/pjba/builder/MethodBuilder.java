...
public class MethodBuilder {
  ...
  public MethodBuilder(final ClassFileBuilder classFileBuilder, final Method method, final int parametersCount) {
  ...
  public MethodBuilder instruction(final Instruction instruction) {
  ...
  public MethodBuilder bipush(final int value) {
    this.code.addInstruction(Instructions.bipush(value));
    return this;
  }

  public MethodBuilder sipush(final int value) {
    this.code.addInstruction(Instructions.sipush(value));
    return this;
  }

  public MethodBuilder ldc(final String value) {
  ...
  public MethodBuilder ldc(final int value) {
  ...
  public MethodBuilder ldc(final float value) {
  ...
  public MethodBuilder ldc(final long value) {
    final int indexInCP = this.classFileBuilder.getClassFile().addConstantLong(value);
    this.code.addInstruction(Instructions.ldc2_w(indexInCP));
    return this;
  }

  public MethodBuilder ldc(final double value) {
  ...
  private void internalLdc(final int indexInCP) {
    if (indexInCP > 255) { // 255 = Byte.MAX_UNSIGNED_VALUE
      this.code.addInstruction(Instructions.ldc_w(indexInCP));
    } else {
      this.code.addInstruction(Instructions.ldc(indexInCP));
    }
  }

  public MethodBuilder iload(final int indexInLV) {
    this.code.addInstruction(Instructions.iload(indexInLV));
    return this;
  }

  public MethodBuilder lload(final int indexInLV) {
    this.code.addInstruction(Instructions.lload(indexInLV));
    return this;
  }

  public MethodBuilder fload(final int indexInLV) {
    this.code.addInstruction(Instructions.fload(indexInLV));
    return this;
  }

  public MethodBuilder dload(final int indexInLV) {
    this.code.addInstruction(Instructions.dload(indexInLV));
    return this;
  }

  public MethodBuilder aload(final int indexInLV) {
  ...
  public MethodBuilder istore(final int indexInLV) {
    this.code.addInstruction(Instructions.istore(indexInLV));
    return this;
  }

  public MethodBuilder lstore(final int indexInLV) {
    this.code.addInstruction(Instructions.lstore(indexInLV));
    return this;
  }

  public MethodBuilder fstore(final int indexInLV) {
    this.code.addInstruction(Instructions.fstore(indexInLV));
    return this;
  }

  public MethodBuilder dstore(final int indexInLV) {
    this.code.addInstruction(Instructions.dstore(indexInLV));
    return this;
  }

  public MethodBuilder astore(final int indexInLV) {
