...
public class Constant {
  ...
  public static class Integer extends ConstantPoolEntry {
    ...
    public Integer(final int integer) {
  ...
  public static class Float extends ConstantPoolEntry {
    ...
    public Float(final float floatValue) {
  ...
  public static class Long extends ConstantPoolEntry {
    ...
    public Long(final long longValue) {
  ...
  public static class Double extends ConstantPoolEntry {
    ...
    public Double(final double doubleValue) {
  ...
  public static class String extends ConstantPoolEntry {
    ...
    public String(final int stringIndex) {
  ...
  public static enum ConstantPoolTag {
    UNDEFINED(0), UTF8(1), INTEGER(3), FLOAT(4), LONG(5), DOUBLE(6), CLASS(7), STRING(8), FIELDREF(9), METHODREF(
        10), INTERFACE_METHODREF(11), NAME_AND_TYPE(12);
