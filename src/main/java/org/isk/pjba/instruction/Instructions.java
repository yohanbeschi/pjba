...
public interface Instructions {
  ...
  public static Instruction bipush(final int value) {
    return new ByteArgInstruction(0x10, 1, 0, value);
  }

  public static Instruction sipush(final int value) {
    return new ShortArgInstruction(0x11, 1, 0, value);
  }

  public static Instruction ldc(final int indexInCP) {
    return new ByteArgInstruction(0x12, 1, 0, indexInCP);
  }

  public static Instruction ldc_w(final int indexInCP) {
    return new ShortArgInstruction(0x13, 1, 0, indexInCP);
  }

  public static Instruction ldc2_w(final int indexInCP) {
    return new ShortArgInstruction(0x14, 2, 0, indexInCP);
  }

  public static Instruction iload(final int indexInLV) {
    return new ByteArgInstruction(0x15, 1, indexInLV + 1, indexInLV);
  }

  public static Instruction lload(final int indexInLV) {
    return new ByteArgInstruction(0x16, 2, indexInLV + 2, indexInLV);
  }

  public static Instruction fload(final int indexInLV) {
    return new ByteArgInstruction(0x17, 1, indexInLV + 1, indexInLV);
  }

  public static Instruction dload(final int indexInLV) {
    return new ByteArgInstruction(0x18, 2, indexInLV + 2, indexInLV);
  }

  public static Instruction aload(final int indexInLV) {
    return new ByteArgInstruction(0x19, 1, indexInLV + 1, indexInLV);
  }
  ...
  public static Instruction istore(final int indexInLV) {
    return new ByteArgInstruction(0x36, -1, indexInLV + 1, indexInLV);
  }

  public static Instruction lstore(final int indexInLV) {
    return new ByteArgInstruction(0x37, -2, indexInLV + 2, indexInLV);
  }

  public static Instruction fstore(final int indexInLV) {
    return new ByteArgInstruction(0x38, -1, indexInLV + 1, indexInLV);
  }

  public static Instruction dstore(final int indexInLV) {
    return new ByteArgInstruction(0x39, -2, indexInLV + 2, indexInLV);
  }

  public static Instruction astore(final int indexInLV) {
    return new ByteArgInstruction(0x3a, -1, indexInLV + 1, indexInLV);
  }
